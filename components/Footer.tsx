        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mb-8 grid gap-8 md:mb-12 md:grid-cols-12 lg:gap-20">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">
                ...
                <Link
                  href="https://github.com/iamlouislab/portfolio-generator"
                ...
                . Built by{" "}
                <Link
                  href="https://portfolio.louisab.tech"
                  className="text-gray-400 transition duration-150 ease-in-out hover:text-gray-100"
                >
                  <span className="underline">Louis AB</span>
                </Link>{" "}
                using Next.js, TypeScript, Tailwind CSS and Supabase.
                <div>
                  This is an educational project and is not intended for sale.
                  All reviews and testimonials are fake. The landing page was
                  inspired by{" "}
                  <Link
                    href="https://www.cruip.com/"
                    className="text-gray-400 transition duration-150 ease-in-out hover:text-gray-100"
                  >
                    <span className="underline">Cruip</span>
                  </Link>
                  .
                </div>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="mr-4 text-sm text-gray-400">
              &copy; louisab.tech. All rights reserved.
            </div>
          </div>
        </div>
      </div>
